...
function RecommendCard({ cardTitle, backgroundURL }: RecommendCardProps ):JSX.Element {
    ...
    return <button ref={buttonRef} type="submit" className={styles.card}>{cardTitle}</button>
}
